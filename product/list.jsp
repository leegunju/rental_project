            ...
            <div class="header">
                ...
                <div class="header-right">
                    <div class="info">
                        ...
                        <a href="/user/signup">회원가입</a> <br> <a href="/user/login">로그인</a> 
                        </c:if>
                        <c:if test="${ses.cid != null }">
                        <a href="/user/modify">회원정보수정</a> <br> <a href="/user/logout">로그아웃</a>
                        </c:if>
                        </div>
                    </div>
...
<h1 class="h1">${firstDto.pvo.type_a} List</h1>
    ...
    <footer>
        <div class="footer" style="background-color: white;">
            <div class="ft-logo">
                <img src="/resources/img/logo2.svg" alt="" width="50px" height="50px">
            </div>
            <div class="footinfo">
				...
				<span class="img-wrapper">
                    <span class="img-container">
				 		    <c:forEach items="${dto.flist}" var="file">
							    <img alt="image" src="/resources/img/1.png">
						    </c:forEach>
                    </span>
				</span>
				<span class="badge-container"> 
