...
<body style="scroll-padding-bottom: 100px;">
	<header>
		...
		<div class="nav-bar" id="nav-bar">
			<a href="/reservation/calender">calender</a> <a href="/reservation/admincalender">Admin_calender</a> <a href="#">project</a>
			<a href="#">phone</a>
		</div>
		...
		<div id="admin-modal-left" class="modal-left">
			<div class="modal-content-left">
				...
				<div class="modal-buttons-left">
					<a href="/product/register"><button class="modal-btn-left">register</button></a>
					<a href="/product/adminList"><button class="modal-btn-left">adminList</button></a>
					<a href="/consult/adminList"><button class="modal-btn-left">consult adminList</button></a>
					<a href="/reservation/admincalender"><button class="modal-btn-left">reservation admin calender</button></a>
				</div>
			</div>
		</div>
	</c:if>
...
<body>
		...
		<div class="container">
			<div class="header">
				...
				<div class="header-right">
					...
					<!-- 230710 서치 -->
					<div class="search">
						<span id="search"> <i class="fa-solid fa-magnifying-glass fa-xl" style="color: #555;"></i>
						</span>
					</div>
				</div>
			</div>
	...
	<main>
		<div class="video-box">
			<video src="/resources/video/video (2160p) (3).mp4" muted autoplay
				loop>
				<source src="/resources/video/video (2160p) (3).mp4"
					type="video/mp4">
			</video>
		</div>
	</main>
	...
	<section>
		...
		<div class="section2">
			<h1 style="color: #555;">Time Sale D-day</h1>
			<video src="/resources/video/230526_oled23_tvc.webm" muted autoplay
				loop></video>
			<div class="cnt">
				<div id="days" class="countdown animated"></div>
				<div id="hours" class="countdown animated"></div>
	...
	<c:if test="${ses.cid eq 'admin' }">
		...
		<div id="admin-modal-left" class="modal-left">
			<div class="modal-content-left">
				<span id="close-button-admin-left">&times;</span>
				<div class="modal-buttons-left">
					<a href="/product/register"><button class="modal-btn-left">register
							temporary</button></a> <a href="/product/adminList"><button
							class="modal-btn-left">adminList temporary</button></a>
				</div>
			</div>
		</div>
	</c:if>
